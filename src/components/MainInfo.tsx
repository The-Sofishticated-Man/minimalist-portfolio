  ...
  return (
    ...
    >
      <div className="text-center max-w-4xl w-full">
        ...
        <div ref={containerRef} className="mb-6 lg:mb-8 cursor-pointer">
          <div
            ref={imageRef}
            className="relative mx-auto w-[120px] h-[120px] sm:w-[150px] sm:h-[150px] md:w-[170px] md:h-[170px] lg:w-[180px] lg:h-[180px] xl:w-[200px] xl:h-[200px]"
          >
            <Image
        ...
        {/* Main heading */}
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-bold mb-3 lg:mb-4 text-white">
          Islam Lameche
        </h1>
        ...
        <div className="mb-6 lg:mb-8">
          <a
            ...
            className="inline-flex items-center bg-white text-black px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-lg hover:bg-gray-100 transition-colors duration-200 font-medium text-xs sm:text-sm md:text-base"
          >
            <svg
              stroke="currentColor"
              fill="currentColor"
